              ...
              >
                <Link href={`/post/${latestPosts.slug.current}`}>
                  <Image
                    ...
                    width={200}
                    quality={100}
                    className="rounded-2xl min-w-[40px] md:max-w-[80px] lg:max-w-[120px] aspect-square object-cover object-center cursor-pointer"
                  />
                </Link>
                <div className="flex flex-col gap-2 items-starts xs:max-w-[120px] sm:max-w-[180px] md:max-w-[130px] lg:max-w-[150px] xl:max-w-[100px]">
                  <div>
                    <Link
